      ...
      {open && (
        <div className="absolute w-full h-screen top-0 left-0 bg-black bg-opacity-65 flex items-center justify-center z-50 ">
          <form
            ...
            className="p-12 bg-white rounded-lg shadow-md grid grid-cols-1 md:grid-cols-2 gap-4 w-full md:w-1/2 xl:w-1/3 relative"
          >
            ...
            {state.success && (
              <span className="text-green-500 col-span-2">
